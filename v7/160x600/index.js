...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/dust1.png?1483633659314", id:"dust1"},
		{src:"images/dust2.png?1483633659314", id:"dust2"},
		{src:"images/ends.png?1483633659314", id:"ends"},
		{src:"images/machine.jpg?1483633659314", id:"machine"},
		{src:"images/room.jpg?1483633659314", id:"room"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,814,1074);
...
p.nominalBounds = new cjs.Rectangle(0,0,407,537);
...
(lib.room_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(481.5,226.7,1.045,1.045,-1,0,0,297.4,220.8);
...
(lib.index = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(6).call(this.frame_6).wait(37).call(this.frame_43).wait(69).call(this.frame_112).wait(107).call(this.frame_219).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},6).wait(203).to({_off:false,alpha:0},0).to({alpha:1},9).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({regX:80,regY:1646.4,rotation:-21.7},23,cjs.Ease.get(0.8)).to({_off:true},1).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},30).wait(200));

	// cta mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_100 = new cjs.Graphics().p("AsfGjIAAtFIY/AAIAANFg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(100).to({graphics:mask_1_graphics_100,x:80,y:562}).wait(130));

	// end copy 3
	this.instance_3 = new lib.end();
	this.instance_3.setTransform(80,563.2,0.95,0.95,0,0,0,80,563.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.instance_3.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(100).to({_off:false},0).to({scaleX:1.05,scaleY:1.05,alpha:1},7).to({scaleX:1,scaleY:1},3).wait(62).to({scaleX:0.95,scaleY:0.95},4).to({scaleX:1.05,scaleY:1.05},4).to({scaleX:1,scaleY:1},4).wait(46));

	// finance (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_77 = new cjs.Graphics().p("AsfD5IAAnxIY/AAIAAHxg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(77).to({graphics:mask_2_graphics_77,x:80,y:195}).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(77).to({_off:false},0).to({alpha:1},6).wait(147));

	// text mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_53 = new cjs.Graphics().p("AsfM+IAAxKIY/AAIAARKg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(53).to({graphics:mask_3_graphics_53,x:80,y:83}).wait(177));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(53).to({_off:false},0).to({alpha:1},10).wait(167));

	// logo mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	var mask_4_graphics_6 = new cjs.Graphics().p("AsfEXIAAouIY/AAIAAIug");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_4_graphics_6,x:80,y:28}).wait(224));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).wait(224));

	// bg
	this.mc = new lib.mc();
	this.mc.setTransform(-88.9,475.1,1.215,1.215,0,0,0,80,300.1);

	this.timeline.addTween(cjs.Tween.get(this.mc).wait(42).to({regX:80.9,regY:300.4,scaleX:0.34,scaleY:0.34,x:82.2,y:356.2},21,cjs.Ease.get(1)).wait(167));
...
p.nominalBounds = new cjs.Rectangle(-977.8,299.5,1357.8,1030.7);
