...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/dust1.png?1483633707780", id:"dust1"},
		{src:"images/dust2.png?1483633707780", id:"dust2"},
		{src:"images/ends.png?1483633707780", id:"ends"},
		{src:"images/machine.jpg?1483633707780", id:"machine"},
		{src:"images/room.jpg?1483633707780", id:"room"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,594,442);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance_3.setTransform(68.8,213.5,0.95,0.95,0,0,0,68.8,213.5);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.instance_3.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(100).to({_off:false},0).to({scaleX:1.05,scaleY:1.05,alpha:1},7).to({scaleX:1,scaleY:1},3).wait(58).to({scaleX:0.95,scaleY:0.95},5).to({scaleX:1.05,scaleY:1.05},4).to({scaleX:1,scaleY:1},4).wait(36));

	// finance (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_77 = new cjs.Graphics().p("A3bFEIAAqHMAu2AAAIAAKHg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(77).to({graphics:mask_2_graphics_77,x:150,y:157.5}).wait(140));
	...
	mask_3._off = true;
	var mask_3_graphics_53 = new cjs.Graphics().p("A3bFFIAAqIMAu2AAAIAAKIg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(53).to({graphics:mask_3_graphics_53,x:150,y:92.5}).wait(164));
	...
	mask_4._off = true;
	var mask_4_graphics_6 = new cjs.Graphics().p("ArtEsIAApXIXbAAIAAJXg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_4_graphics_6,x:75,y:30}).wait(211));
	...
	// bg
	this.mc = new lib.mc();
	this.mc.setTransform(80,300,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.mc).wait(42).to({regX:80.1,regY:299.9,scaleX:0.29,scaleY:0.29,x:227,y:107.1},21,cjs.Ease.get(1)).wait(154));
...
p.nominalBounds = new cjs.Rectangle(-567.4,41.9,1018,840.1);
