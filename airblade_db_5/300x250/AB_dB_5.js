...
(lib.logo = function() {
	...
	this.shape.setTransform(303.5,15.7);
	...
	this.shape_2.setTransform(280.8,16);
	...
	this.shape_3.setTransform(225.9,16);
	...
	this.shape_4.setTransform(202.2,20.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#B2B2B2").s().p("AgUCWIAAkrIAqAAIAAErg");
	this.shape_5.setTransform(186.2,15.7);
	...
	this.shape_8.setTransform(140.5,16.8);
	...
	this.shape_9.setTransform(124.2,20.9);
	...
	this.shape_10.setTransform(28.8,26.3);
	...
	this.shape_11.setTransform(49.9,20.9);
	...
	this.shape_12.setTransform(93,20.7);
	...
	this.shape_13.setTransform(70.3,20.9);
	...
	this.shape_14.setTransform(5.4,15.9);
...
p.nominalBounds = new cjs.Rectangle(-4.9,0.6,318,40.9);
...
// stage content:
(lib.AB_dB_5 = function(mode,startPosition,loop) {
	...
	this.instance_14.setTransform(150,132,0.944,0.944,0,0,0,150,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(301).to({_off:false},0).to({scaleX:1,scaleY:1,y:125,alpha:1},6).wait(55));

	// i1
	this.instance_15 = new lib.i1();
	this.instance_15.setTransform(147,137,0.918,0.918,0,0,0,150,125);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(1).to({_off:false},0).to({scaleX:1,scaleY:1,x:150,y:125},15,cjs.Ease.get(1)).wait(38).to({x:-150},11,cjs.Ease.get(-1)).to({_off:true},1).wait(296));
