...
(lib.logo = function() {
	...
	this.shape.graphics.f("#B2B2B2").s().p("AhgCWIAAkrIBMAAQAcAAAXAWQAVAWAAAfQABAWgMATQAZAMAPAVQAQAYAAAdQgBAogcAdQgdAcgnAAgAg1BrIA1AAQAWAAAPgQQARgQgBgWQAAgWgPgQQgQgPgWAAIg1AAgAg1gqIAhAAQANAAAHgJQAKgKgBgNQABgNgKgKQgHgJgNAAIghAAg");
	this.shape.setTransform(299.7,15.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#B2B2B2").s().p("AhMBHQgcgfAAgoQABgtAhgeQAggcAnAAQApAAAfAeQAgAfgBAqIgCAPIifAAQAEAUAPANQASAPAVAAQAcAAAhgVIAaAgQgoAegtAAQgvAAggghgAgjgxQgQAMgEARIBvAAQgEgPgOgNQgQgPgVAAQgTAAgRAOg");
	this.shape_1.setTransform(245.8,21);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#B2B2B2").s().p("AhHB8QgdgdAAgsQAAgqAegbQAggeAoAAIA3AAIAAhpIAsAAIAADMQABAqgeAeQgeAfgpgBQgrAAgdgdgAgnAKQgRASAAAYQAAAcATAQQAQAOAWAAQAXAAAQgRQARgRAAgZIAAg4Ig4AAQgWAAgSAPg");
	this.shape_2.setTransform(277,16.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#B2B2B2").s().p("AhIB8QgdgdAAgsQAAgqAggbQAegeApAAIA3AAIAAhpIAtAAIAADMQgBAqgdAeQgeAfgqgBQgrAAgdgdgAgnAKQgSASAAAYQABAcASAQQARAOAVAAQAYAAAQgRQARgRAAgZIAAg4Ig5AAQgWAAgRAPg");
	this.shape_3.setTransform(222.1,16.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#B2B2B2").s().p("AhLBHQgdgfABgoQgBguAjgeQAegbAnAAQApAAAeAbQAhAeAAAuIAABiIgsAAIAAgOQgbAUghAAQgsAAgfghgAgpgpQgSASAAAXQAAAYARASQARATAZAAQAZAAARgSQATgSgBgZQAAgbgTgRQgSgQgXAAQgYAAgRATg");
	this.shape_4.setTransform(198.4,21);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#B2B2B2").s().p("AgUCWIAAkrIAqAAIAAErg");
	this.shape_5.setTransform(182.4,15.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#B2B2B2").s().p("AhJB6QgcgeAAgpIAAjMIAtAAIAABpIA1AAQAqAAAfAeQAgAcAAApQAAAsgdAdQgeAdgrAAQgrABgegggAg4A4QAAASAPARQAQAUAZgBQAaABAQgUQAPgQABgXQgBgXgPgQQgRgRgcgBIg1AAg");
	this.shape_6.setTransform(166.8,16.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#B2B2B2").s().p("Ag3BlIAAhhQAAgwAhgdQAbgbApAAIAKAAIAAAoQgGAAgKACQgzAJAAA2IAABgg");
	this.shape_7.setTransform(148.3,20.7);
	...
	this.shape_8.setTransform(136.7,16.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#B2B2B2").s().p("AhLBHQgcgfgBgoQAAguAigeQAfgbAnAAQApAAAeAbQAiAeAAAuIAABiIgtAAIAAgOQgaAUgiAAQgtAAgeghgAgqgpQgRASAAAXQAAAYARASQARATAZAAQAZAAARgSQASgSAAgZQAAgbgTgRQgRgQgYAAQgXAAgTATg");
	this.shape_9.setTransform(120.4,21);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ag6CNIgigUIAbglQAHAFALAFQATAJAPABQAkAAAPggQAKgTAAgYQgIAJgQAFQgNAFgLAAQgqAAgdgdQgegbAAgrIAAhkIA2AAIAABkQAAAUAOAPQAOAOATAAQAUAAAOgOQAOgOAAgVIAAhkIA2AAIAABkQAABbgJAhQgQA9g5AOQgPAEgNAAQgZAAgZgLg");
	this.shape_10.setTransform(25,26.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgKBmQgsgHgfgYIAagjQAMAJAVAGQAaAIARgEQANgDADgIQADgHgJgFQgFgCgegJQgggJgOgJQgagOAAgbIAFgZQAPgcAkgHQASgEAMACQAtADAZAUIgZAjQgSgIgUgDQgRgCgMADQgKADgCAGQgCAFAGAEQAGAEAcAIQAfAJAOAHQAgAPgBAfQgBAUgLANQgTAYgjAFg");
	this.shape_11.setTransform(46.1,20.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAwBkIAAhiQAAgTgOgNQgOgPgUAAQgSAAgPAPQgOANAAATIAABiIg2AAIAAhiQAAgpAegeQAegeApAAQAqAAAeAeQAeAeAAApIAABig");
	this.shape_12.setTransform(89.2,20.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhHBIQgegeAAgqQAAgpAegeQAegeApAAQAqAAAeAeQAeAeAAApQAAAqgeAeQgeAegqAAQgpAAgegegAghghQgPAOAAATQAAAUAPAOQAOAOATAAQAUAAAOgOQAOgOAAgUQAAgTgOgOQgOgPgUAAQgTAAgOAPg");
	this.shape_13.setTransform(66.5,21);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhIB6QgegeAAgrQAAgqAegcQAfgeApAAIAwAAIAAhkIA3AAIAADIQgBArgeAeQgeAegqAAQgpAAgfgegAghAPQgPAOABAUQgBAVAPAOQAPAOASAAQAUAAAOgOQAOgOAAgVIAAgwIgwAAQgTAAgOAOg");
	this.shape_14.setTransform(1.6,16);
...
p.nominalBounds = new cjs.Rectangle(-8.7,0.7,318.1,40.9);
...
// stage content:
(lib.AB_dB_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.numba).wait(121).to({_off:false},0).to({x:151.4},10,cjs.Ease.get(1)).wait(50).to({x:-158.6},8).to({_off:true},1).wait(155));
	...
	var mask_graphics_122 = new cjs.Graphics().p("AmOVYMAAAgqvMAteAAAMggbAqvg");
	var mask_graphics_123 = new cjs.Graphics().p("Ap8VYMAAAgqvMAteAAAMggbAqvg");
	var mask_graphics_124 = new cjs.Graphics().p("AtOVYMAAAgqvMAteAAAMggZAqvg");
	var mask_graphics_125 = new cjs.Graphics().p("AwEVYMAAAgqvMAteAAAMggZAqvg");
	var mask_graphics_126 = new cjs.Graphics().p("AyeVYMAAAgqvMAteAAAMggZAqvg");
	var mask_graphics_127 = new cjs.Graphics().p("A0cVYMAAAgqvMAteAAAMggZAqvg");
	var mask_graphics_128 = new cjs.Graphics().p("A1+VYMAAAgqvMAteAAAMggZAqvg");
	var mask_graphics_129 = new cjs.Graphics().p("A2uVYMAAAgqvMAtdAAAMggYAqvg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:0,y:0}).wait(121).to({graphics:mask_graphics_121,x:410.1,y:125.9}).wait(1).to({graphics:mask_graphics_122,x:251.2,y:125.9}).wait(1).to({graphics:mask_graphics_123,x:227.4,y:125.9}).wait(1).to({graphics:mask_graphics_124,x:206.4,y:125.9}).wait(1).to({graphics:mask_graphics_125,x:188.2,y:125.9}).wait(1).to({graphics:mask_graphics_126,x:172.8,y:125.9}).wait(1).to({graphics:mask_graphics_127,x:160.2,y:125.9}).wait(1).to({graphics:mask_graphics_128,x:150.4,y:125.9}).wait(1).to({graphics:mask_graphics_129,x:141.3,y:125.9}).wait(1).to({graphics:mask_graphics_130,x:132.9,y:125.9}).wait(1).to({graphics:mask_graphics_131,x:130.1,y:125.9}).wait(50).to({graphics:mask_graphics_181,x:130.1,y:125.9}).wait(1).to({graphics:mask_graphics_182,x:91.3,y:125.9}).wait(1).to({graphics:mask_graphics_183,x:52.6,y:125.9}).wait(1).to({graphics:mask_graphics_184,x:13.8,y:125.9}).wait(1).to({graphics:mask_graphics_185,x:-24.9,y:125.9}).wait(1).to({graphics:mask_graphics_186,x:-63.7,y:125.9}).wait(1).to({graphics:mask_graphics_187,x:-102.4,y:125.9}).wait(1).to({graphics:mask_graphics_188,x:-141.2,y:125.9}).wait(1).to({graphics:mask_graphics_189,x:-162.8,y:125.9}).wait(1).to({graphics:null,x:0,y:0}).wait(155));

	// img5
	this.instance_7 = new lib.img5();
	this.instance_7.setTransform(430.1,162.7,1,1,-87.8,0,0,150.1,163.1);
	this.instance_7._off = true;

	this.instance_7.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(121).to({_off:false},0).to({regX:150,regY:163,rotation:-61.1,x:150.1,y:162.9},10,cjs.Ease.get(1)).to({rotation:0,x:150,y:163},18,cjs.Ease.get(-0.11)).wait(32).to({x:-160},8).to({_off:true},1).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(121).to({_off:false},0).to({x:150,alpha:1},10,cjs.Ease.get(1)).wait(50).to({x:-160},8).to({_off:true},1).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(67).to({_off:false},0).to({x:153.5},7,cjs.Ease.get(1)).wait(47).to({x:-126.5},10,cjs.Ease.get(1)).to({_off:true},1).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(95).to({_off:false},0).wait(26).to({x:-48.5},10,cjs.Ease.get(1)).to({_off:true},1).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(82).to({_off:false},0).wait(39).to({x:-191.5},10,cjs.Ease.get(1)).to({_off:true},1).wait(213));
	...
	var mask_1_graphics_128 = new cjs.Graphics().p("A3aTiMAAAgnDMAu2AAAMAAAAnDg");
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(95).to({graphics:mask_1_graphics_95,x:150,y:118}).wait(26).to({graphics:mask_1_graphics_121,x:150,y:118}).wait(1).to({graphics:mask_1_graphics_122,x:93,y:118}).wait(1).to({graphics:mask_1_graphics_123,x:42,y:118}).wait(1).to({graphics:mask_1_graphics_124,x:-3,y:118}).wait(1).to({graphics:mask_1_graphics_125,x:-42,y:118}).wait(1).to({graphics:mask_1_graphics_126,x:-75,y:118}).wait(1).to({graphics:mask_1_graphics_127,x:-102,y:118}).wait(1).to({graphics:mask_1_graphics_128,x:-123,y:118}).wait(1).to({graphics:mask_1_graphics_129,x:-138,y:118}).wait(1).to({graphics:mask_1_graphics_130,x:-147,y:118}).wait(1).to({graphics:mask_1_graphics_131,x:-150,y:118}).wait(1).to({graphics:null,x:0,y:0}).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(95).to({_off:false},0).to({alpha:1},3).wait(23).to({x:-150},10,cjs.Ease.get(1)).to({_off:true},1).wait(213));
	...
	var mask_2_graphics_128 = new cjs.Graphics().p("A3aTiMAAAgnDMAu2AAAMAAAAnDg");
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(82).to({graphics:mask_2_graphics_82,x:0,y:118}).wait(39).to({graphics:mask_2_graphics_121,x:150,y:118}).wait(1).to({graphics:mask_2_graphics_122,x:93,y:118}).wait(1).to({graphics:mask_2_graphics_123,x:42,y:118}).wait(1).to({graphics:mask_2_graphics_124,x:-3,y:118}).wait(1).to({graphics:mask_2_graphics_125,x:-42,y:118}).wait(1).to({graphics:mask_2_graphics_126,x:-75,y:118}).wait(1).to({graphics:mask_2_graphics_127,x:-102,y:118}).wait(1).to({graphics:mask_2_graphics_128,x:-123,y:118}).wait(1).to({graphics:mask_2_graphics_129,x:-138,y:118}).wait(1).to({graphics:mask_2_graphics_130,x:-147,y:118}).wait(1).to({graphics:mask_2_graphics_131,x:-150,y:118}).wait(1).to({graphics:null,x:0,y:0}).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(82).to({_off:false},0).to({alpha:1},3).wait(36).to({x:-150},10,cjs.Ease.get(1)).to({_off:true},1).wait(213));
