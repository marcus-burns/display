...
// stage content:
(lib.AB_tap_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(78).call(this.frame_78).wait(243).call(this.frame_321).wait(22).call(this.frame_343).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:0.09},5).to({_off:true},1).wait(65).to({_off:false},0).to({alpha:1},6).wait(4).to({alpha:0.09},5).to({_off:true},1).wait(116).to({_off:false},0).to({alpha:1},8).wait(8).to({alpha:0.09},5).to({_off:true},1).wait(108).to({_off:false},0).to({alpha:1},6).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(89).to({_off:false},0).to({alpha:1},9).wait(100).to({alpha:0.09},5).to({_off:true},1).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(7).to({_off:false},0).to({alpha:1},5).wait(54).to({alpha:0.09},5).to({_off:true},1).wait(272));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(218).to({_off:false},0).wait(126));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc2).wait(78).to({_off:false},0).to({scaleX:1.13,scaleY:1.13},133).to({_off:true},1).wait(132));

	// img0
	this.instance_8 = new lib.img0_1();
	this.instance_8.setTransform(150,125.1,1.1,1.1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({scaleX:1,scaleY:1,y:125},76,cjs.Ease.get(0.5)).to({_off:true},2).wait(266));

	// white
	this.instance_9 = new lib.white();
	this.instance_9.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(344));
